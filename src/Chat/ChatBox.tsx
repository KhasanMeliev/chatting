...
const ChatBox = () => {
  ...
  const handleNewUserImage = async () => {
    ...
    setChatMessages([
      ...chatMessages,
      { question: message, response: chatResponse.choices[0].message },
    ]);
    setMessage("");
    setTyping(false);
  };
    ...
    <div className="wrapper">
      ...
      <div className="messages">
        <div className="chatting">
          {chatMessages.map((msg) => (
            <>
              ...
              <div className="answer">{msg.response.content}</div>
            </>
          ))}
        </div>
        <div className="sendBox">
          ...
          />
          <button onClick={handleNewUserImage}>
            <AiOutlineSend />
          </button>
        </div>
      </div>
